...
import NProgressStyle, {
  Props as NProgressStyleProps,
} from './Nprogress.style';

export type Options = NProgressOptions & {
  ...
  return (
    ...
    >
      ...
      <NProgressStyle
        ...
        barHeight={options?.barHeight || '2px'}
      />
    </ProgressContext.Provider>
  );
};

export const useUpdateProgressConfig = () =>
  useContext(ProgressContext).updateOptions;
